...
En el presente trabajo se visualizara una base de datos llamada Stackloss la cual nos muestra los datos operativos de una planta de oxidación de amoniaco a ácido nítrico. la cual posee un marco de datos con 21 observaciones sobre 4 variables
